...
## Tutorial
Tutorial Jupyter Notebook is provided as [`Tutorial.ipynb`](Tutorial.ipynb) (You can run in  [![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Masaaaato/DynProfiler/blob/main/Tutorial.ipynb) )  
This includes:
1. Embed the dynamics
