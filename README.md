...
## Tutorial
Tutorial Jupyter Notebook is provided as `[Tutorial.ipynb](https://github.com/Masaaaato/DynProfiler/blob/main/Tutorial.ipynb)` (You can run in  [![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/?hl=en) )  
This includes:
1. Embed the dynamics
